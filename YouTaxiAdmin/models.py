...
class Car(models.Model):
    ...
    licenseAuthorizationDate = models.DateTimeField(auto_now_add=True)
    ...
    vtCard = models.TextField(default="")
    buyDate = models.DateTimeField(auto_now_add=True)
    registrationDate = models.DateTimeField(auto_now_add=True)
    lastITVdate = models.DateTimeField(auto_now_add=True)
    lastMetropolitandate = models.DateTimeField(auto_now_add=True)
    lastVerificationdate = models.DateTimeField(auto_now_add=True)
